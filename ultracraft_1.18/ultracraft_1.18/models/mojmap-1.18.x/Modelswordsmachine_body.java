...
public class Modelswordsmachine_body<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "swordsmachine_body"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(46, 10)
						.addBox(-0.9F, -1.9F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.1F)).texOffs(0, 41)
		...
		PartDefinition cube_r1 = LeftArm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(52, 16)
						.addBox(-1.0F, 0.5F, 0.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(52, 16)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(15, 53)
						.addBox(-1.5F, 15.0F, -1.5F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 0)
		...
		PartDefinition cube_r2 = RightArm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(50, 39).addBox(-2.0F, -0.4F, -1.5F, 1.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 3.0F, 0.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(12, 13)
						.addBox(-4.0F, 1.0F, -2.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 16)
						...
						.addBox(-4.5F, 0.5F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 25)
						.mirror().addBox(1.5F, 0.5F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(43, 33).addBox(2.0F, -3.0F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r4 = Body
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(32, 37).addBox(-4.0F, -3.0F, -2.0F, 2.0F, 5.0F, 4.0F,
								new CubeDeformation(0.1F)),
						PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition cube_r5 = Body
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(22, 22).addBox(-4.0F, 0.0F, 0.5F, 8.0F, 2.0F, 1.0F,
								new CubeDeformation(0.0F)),
