...
public class Modelv1_head<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "v1_head"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(47, 29).mirror()
						.addBox(1.0F, -31.0F, 5.5F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(47, 29).addBox(-2.0F, -31.0F, 5.5F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(64, 24).addBox(-1.5F, -27.0F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 18).addBox(-2.0F, -31.0F, -0.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(0, 23).addBox(-2.0F, -31.0F, 0.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(37, 30).mirror()
		...
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(37, 30).addBox(-2.0F, -31.7F, -4.5F, 1.0F, 1.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, -0.0436F, 0.0F));

		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4",
				CubeListBuilder.create().texOffs(51, 41).mirror()
		...
		PartDefinition Head_r5 = Head.addOrReplaceChild("Head_r5",
				CubeListBuilder.create().texOffs(51, 41).addBox(-3.6F, -27.5F, -1.5F, 1.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0873F, 0.0436F, 0.0436F));

		PartDefinition Head_r6 = Head.addOrReplaceChild("Head_r6",
				CubeListBuilder.create().texOffs(27, 46).mirror()
		...
		PartDefinition Head_r7 = Head.addOrReplaceChild("Head_r7",
				CubeListBuilder.create().texOffs(27, 46).addBox(2.3F, -29.4F, -4.5F, 1.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 0.0436F, -0.1745F));
		...
		PartDefinition Head_r9 = Head.addOrReplaceChild("Head_r9",
				CubeListBuilder.create().texOffs(34, 0).addBox(-6.5F, -30.5F, -6.3F, 1.0F, 2.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, -0.0436F, 0.0436F, 0.1309F));

		PartDefinition neck_r1 = Head.addOrReplaceChild("neck_r1",
				CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, -23.0F, -15.5F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
