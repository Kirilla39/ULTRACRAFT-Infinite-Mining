...
public class Modelv2_body<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "v2_body"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(14, 45)
				.mirror().addBox(-0.5F, 3.0F, -0.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(60, 64).mirror().addBox(-0.5F, 0.5F, -1.0F, 2.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F))
				.mirror(false).texOffs(58, 64).mirror()
				.addBox(1.0F, 0.5F, 0.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false),
		...
		PartDefinition shoulder_r1 = LeftArm.addOrReplaceChild("shoulder_r1",
				CubeListBuilder.create().texOffs(53, 57).mirror()
		...
		PartDefinition shoulder_r2 = LeftArm.addOrReplaceChild("shoulder_r2",
				CubeListBuilder.create().texOffs(58, 60).mirror()
		...
		PartDefinition shoulder_r3 = LeftArm.addOrReplaceChild("shoulder_r3",
				CubeListBuilder.create().texOffs(59, 53).mirror()
		...
		PartDefinition LLlowerarm = LeftArm.addOrReplaceChild("LLlowerarm",
				CubeListBuilder.create().texOffs(46, 54).mirror()
						.addBox(-0.5F, 3.0F, -2.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(69, 68).mirror().addBox(0.5F, 4.0F, -2.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.2F))
						.mirror(false),
				PartPose.offset(0.0F, 5.0F, 1.0F));

		PartDefinition hand_r1 = LLlowerarm.addOrReplaceChild("hand_r1",
				CubeListBuilder.create().texOffs(74, 68).mirror()
						.addBox(4.0F, -11.2F, 0.7F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(74, 68).mirror()
						.addBox(4.0F, -11.2F, -0.7F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0F, 17.0F, -1.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition hand_r2 = LLlowerarm.addOrReplaceChild("hand_r2",
				CubeListBuilder.create().texOffs(63, 71).mirror()
		...
		PartDefinition lowerarm_r1 = LLlowerarm.addOrReplaceChild("lowerarm_r1", CubeListBuilder.create()
				.texOffs(68, 64).mirror().addBox(4.0F, -15.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(45, 62).mirror()
				.addBox(4.0F, -18.0F, 0.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(46, 65)
				.mirror().addBox(4.0F, -17.0F, -1.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0F, 17.0F, -1.0F, -0.0436F, 0.0F, 0.0F));

		PartDefinition elbow_r1 = LLlowerarm.addOrReplaceChild("elbow_r1",
				CubeListBuilder.create().texOffs(70, 57).mirror()
		...
		PartDefinition elbow_r2 = LLlowerarm.addOrReplaceChild("elbow_r2",
				CubeListBuilder.create().texOffs(70, 57).mirror()
		...
		PartDefinition shoulder_r4 = RightArm
				.addOrReplaceChild("shoulder_r4",
						CubeListBuilder.create().texOffs(0, 43).addBox(-8.0F, -24.0F, -1.0F, 3.0F, 3.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition RLowerarm = RightArm.addOrReplaceChild("RLowerarm", CubeListBuilder.create().texOffs(36, 21)
				.addBox(-1.5F, 3.0F, -2.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 5.0F, 1.0F));
