...
public class Modelminos_prime_boss<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "minos_prime_boss"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(74, 34)
				.mirror().addBox(-1.4F, 10.0F, -2.3F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(53, 2).mirror().addBox(-1.9F, 11.7F, -2.3F, 5.0F, 5.0F, 5.0F, new CubeDeformation(-0.1F))
				.mirror(false).texOffs(48, 67).mirror()
				.addBox(-1.4F, 16.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 81)
				.mirror().addBox(-0.9F, 10.0F, 0.0F, 2.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 13).mirror().addBox(-0.9F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(0, 13).addBox(-5.9F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.9F, 0.0F, 0.0F));

		PartDefinition feet_r1 = LeftLeg.addOrReplaceChild("feet_r1", CubeListBuilder.create().texOffs(78, 61).mirror()
				.addBox(0.5F, -2.0F, -3.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(54, 18)
				.mirror().addBox(0.5F, -3.0F, -6.4F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.9F, 24.0F, 0.0F, 0.2618F, -0.0873F, 0.0F));

		PartDefinition feet_r2 = LeftLeg.addOrReplaceChild("feet_r2", CubeListBuilder.create().texOffs(0, 13).mirror()
				.addBox(0.0F, -1.0F, -7.0F, 5.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(15, 59)
				.mirror().addBox(0.0F, -3.0F, -2.5F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(74, 34)
						.addBox(-2.6F, 10.0F, -2.3F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 67)
		...
		PartDefinition feet_r3 = RightLeg.addOrReplaceChild("feet_r3",
				CubeListBuilder.create().texOffs(15, 59)
						.addBox(-5.0F, -3.0F, -2.5F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 13)
						.addBox(-5.0F, -1.0F, -7.0F, 5.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.9F, 24.0F, 0.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition feet_r4 = RightLeg.addOrReplaceChild("feet_r4",
				CubeListBuilder.create().texOffs(78, 61)
						.addBox(-4.5F, -2.0F, -3.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 18)
		...
		PartDefinition RightLeg_r1 = RightLeg.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(40, 14).addBox(-3.3F, 5.0F, -2.7F, 5.0F, 5.0F, 5.0F,
						new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(-0.1F, 1.0F, 0.0F, 0.0436F, 0.0F, 0.0F));

		PartDefinition RightLeg_r2 = RightLeg
				.addOrReplaceChild("RightLeg_r2",
						CubeListBuilder.create().texOffs(0, 44).addBox(-3.0F, -1.0F, -2.4F, 5.0F, 7.0F, 5.0F,
		...
		PartDefinition upperarm_r1 = LeftArm.addOrReplaceChild("upperarm_r1",
				CubeListBuilder.create().texOffs(0, 72).mirror()
						.addBox(5.5F, -21.0F, -1.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).mirror(false)
						.texOffs(62, 25).mirror()
						.addBox(5.0F, -25.0F, -2.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0F, 22.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition lowerarm_l = LeftArm.addOrReplaceChild("lowerarm_l", CubeListBuilder.create(),
				PartPose.offset(1.0F, 6.0F, 0.0F));

		PartDefinition hand_r1 = lowerarm_l.addOrReplaceChild("hand_r1",
				CubeListBuilder.create().texOffs(40, 76).mirror()
		...
		PartDefinition snake_r1 = lowerarm_l.addOrReplaceChild("snake_r1",
				CubeListBuilder.create().texOffs(26, 72).mirror()
						.addBox(6.5F, -5.0F, -2.2F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(30, 58).mirror().addBox(6.5F, 0.5F, -2.5F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(13, 67).mirror()
						.addBox(6.7F, -2.5F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-7.0F, 7.0F, 0.0F, -0.0436F, 0.0F, -0.1309F));

		PartDefinition lowerarm_r1 = lowerarm_l.addOrReplaceChild("lowerarm_r1",
				CubeListBuilder.create().texOffs(16, 74).mirror()
		...
		PartDefinition elbow_r1 = lowerarm_l.addOrReplaceChild("elbow_r1",
		...
		PartDefinition upperarm_r2 = RightArm.addOrReplaceChild("upperarm_r2",
				CubeListBuilder.create().texOffs(0, 72)
						.addBox(-8.5F, -21.0F, -1.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(62, 25)
						.addBox(-8.0F, -25.0F, -2.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition lowerarm_r = RightArm.addOrReplaceChild("lowerarm_r", CubeListBuilder.create(),
				PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition hand_r2 = lowerarm_r
				.addOrReplaceChild("hand_r2",
						CubeListBuilder.create().texOffs(40, 76).addBox(-8.0F, -13.0F, -2.0F, 3.0F, 3.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition snake_r2 = lowerarm_r.addOrReplaceChild("snake_r2",
				CubeListBuilder.create().texOffs(26, 72)
						.addBox(-10.5F, -5.0F, -2.2F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)).texOffs(30, 58)
						.addBox(-10.5F, 0.5F, -2.5F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)).texOffs(13, 67)
						.addBox(-10.7F, -2.5F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, 7.0F, 0.0F, -0.0436F, 0.0F, 0.1309F));

		PartDefinition lowerarm_r2 = lowerarm_r.addOrReplaceChild("lowerarm_r2",
				CubeListBuilder.create().texOffs(0, 64).addBox(-2.0F, -1.2F, -2.0F, 4.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 1.0F, 0.0F, -0.0436F, -0.1745F, 0.0436F));

		PartDefinition lowerarm_r3 = lowerarm_r.addOrReplaceChild("lowerarm_r3",
				CubeListBuilder.create().texOffs(16, 74).addBox(-8.5F, -19.0F, -1.5F, 3.0F, 6.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, -0.0436F, -0.1745F, 0.0436F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -15.0F, -2.0F, 10.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 35)
		...
		PartDefinition Head_r1 = Head
				.addOrReplaceChild("Head_r1",
						CubeListBuilder.create().texOffs(35, 47).addBox(1.5F, -4.0F, -1.0F, 2.0F, 3.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition Head_r2 = Head
				.addOrReplaceChild("Head_r2",
						CubeListBuilder.create().texOffs(4, 81).addBox(1.0F, -6.0F, -3.0F, 2.0F, 5.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition Head_r3 = Head
				.addOrReplaceChild("Head_r3",
						CubeListBuilder.create().texOffs(15, 44).addBox(-2.0F, -5.0F, -3.0F, 2.0F, 3.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(31, 25)
						.addBox(-1.0F, 4.2F, -3.3F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)).texOffs(22, 27)
		...
		PartDefinition chin_r1 = Head.addOrReplaceChild("chin_r1",
				CubeListBuilder.create().texOffs(23, 25)
						.addBox(-1.5F, -25.3F, -2.8F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(55, 12)
		...
		PartDefinition Head_r4 = Head
				.addOrReplaceChild("Head_r4",
						CubeListBuilder.create().texOffs(58, 36).addBox(-3.0F, -3.0F, -1.5F, 6.0F, 4.0F, 4.0F,
								new CubeDeformation(-0.1F)),
