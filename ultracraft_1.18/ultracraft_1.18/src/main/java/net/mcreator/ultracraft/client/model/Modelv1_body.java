...
public class Modelv1_body<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ultracraft", "modelv_1_body"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(36, 21).mirror().addBox(-0.5F, 8.0F, -1.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(14, 45).mirror().addBox(-0.5F, 3.0F, -0.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 58).mirror().addBox(-0.5F, 0.5F, -1.0F, 2.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)).mirror(false),
		...
		PartDefinition shoulder_r1 = LeftArm.addOrReplaceChild(
				"shoulder_r1", CubeListBuilder.create().texOffs(0, 43).mirror()
		...
		PartDefinition lowerarm_r1 = LeftArm.addOrReplaceChild("lowerarm_r1",
				CubeListBuilder.create().texOffs(66, 10).mirror().addBox(4.0F, -15.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(57, 0).mirror().addBox(4.0F, -17.0F, -1.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0F, 22.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(36, 21).addBox(-1.5F, 8.0F, -1.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
		...
		PartDefinition lowerarm_r2 = RightArm.addOrReplaceChild("lowerarm_r2",
				...
				PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
		PartDefinition shoulder_r2 = RightArm.addOrReplaceChild("shoulder_r2",
