...
public class Modelswordsmachine_legs<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ultracraft", "modelswordsmachine_legs"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(7, 49).addBox(-0.4F, 9.0F, -1.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(11, 22)
						.mirror().addBox(-1.4F, 10.0F, -3.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(43, 28)
		...
		PartDefinition feet_r1 = LeftLeg.addOrReplaceChild("feet_r1",
				CubeListBuilder.create().texOffs(0, 17).addBox(-0.5F, -1.2F, 2.7F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 11.0F, -2.0F, -0.0436F, 0.0F, 0.0F));
		PartDefinition feet_r2 = LeftLeg.addOrReplaceChild("feet_r2",
				CubeListBuilder.create().texOffs(0, 20).addBox(-0.5F, -1.0F, -2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(11, 22).addBox(-1.6F, 10.0F, -3.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(53, 0)
		...
		PartDefinition feet_r4 = RightLeg.addOrReplaceChild("feet_r4",
				CubeListBuilder.create().texOffs(0, 17).addBox(-4.5F, -1.2F, 2.7F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
