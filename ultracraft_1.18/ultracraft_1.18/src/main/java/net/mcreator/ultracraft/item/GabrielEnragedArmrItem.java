...
import net.mcreator.ultracraft.procedures.GabrielEnragedArmrHelmetEventProcedure;
...
public abstract class GabrielEnragedArmrItem extends ArmorItem {
	public GabrielEnragedArmrItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends GabrielEnragedArmrItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "ultracraft:textures/entities/gabriel_enraged.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			GabrielEnragedArmrHelmetEventProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		}
	}

	public static class Chestplate extends GabrielEnragedArmrItem {
		public Chestplate() {
	...
	public static class Leggings extends GabrielEnragedArmrItem {
		public Leggings() {
